...
// 분,초,0.01초를 출력하는 span 태그들을 배열로 얻어옴
...
/* START 버튼이 클릭된 경우 
1. start 버튼 <-> pause 버튼으로 변경
2. start가 클릭된 경우 10ms 마다 count가 1씩 증가
3. count 증가 후 화면에 시간을 계산해서 출력(별도 함수)

*/
startBtn.addEventListener("click",()=>{

    // 1. START <-> PAUSE 버튼으로 변경
...
/** 전달 받은 수가 10 미만이면 앞에 "0을 붙여 반환하는 함수" 
 * @param num : 숫자
*/
