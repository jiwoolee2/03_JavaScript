...
function check1(){
    ...
    console.log("num2 !== num3 :" ,num2 !== num3); //true
     // number , string 동등 비교
     console.log("num1 === str1 :" ,num1 === str1); //false  /* > 자료형이 다름 */
    
    //  초과,미만,이상,이하
    console.log("num1 > num2 :", numn1 > num2); //false
    console.log("num1 >= num2 :", numn1 >= num2); //true
}

/** 홀짝 판별기 */
function oddEvenCheck(){
    const input1 = document.getElementById("input1");
    /* #input에서 작성된 값 얻어 number 타입으로 변환해 변수 저장 */
...
function andCheck(){
    ...
    // 50은 70이하의 숫자이고 4의 배수인가?
    const bool2 = 50<=70 && 50%4 === 0;
    console.log(`50은 70이하의 숫자이고 4의 배수인가? ${bool2}`);
