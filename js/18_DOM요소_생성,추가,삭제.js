...
for (let btn of btns) {
    btn.addEventListener("click", (e) => {
        ...
        // 클릭된 버튼에 작성된 내용 얻어오기
        const str = e.target.innerText; // prepend, append, before, after, remove
        ...
        switch (str) {
            ...
            case "before":
                const div1 = document.createElement("div"); // div 요소 새애성
                div1.className = "box" ; //div 요소에 box 클래스 추가
                div1.style.backgroundColor="orange";
                div1.innerText=count; //div의 내용으로 count 추가 (TextNode 대신사용)
