...
checkBtn1.addEventListener("click",()=>{
    ...
    console.log("lasttChild :",parent.lastChild);
...
checkBtn2.addEventListener("click",()=>{
    ...
    // parnet의 1번 index 자식의 이전 형제 요소(previousElementSibling)
    console.log(parent.children[1].previousElementSibling);
    
    // parnet의 1번 index 자식의 다음 형제 요소(nextElementSibling)
